...
#TODO Do not forget that sequence must be same with agents_and_tools
prompt_templates = [
...
def agent_router(
                 ...
                 agents_and_tools : list[tuple[RunnableSerializable , list[BaseTool]]],
    ...
    :param agents_and_tools: A list contains lists of agents and that agent's tools example = list[(agent1 , tool1) , (agen2 , tool2)]
    ...
    most_similar = agents_and_tools[max_idx]
    return most_similar
