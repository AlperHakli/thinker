...
database_analysis_agent_prompt: ChatPromptTemplate = ChatPromptTemplate.from_messages([
    ...
    You MUST call load_db tool first
    You MUST call final_answer tool last
...
supervisor_agent_prompt = ChatPromptTemplate.from_messages([
    ...
    ONLY call the agent if you have to call it you can complete some tasks only with single agent
